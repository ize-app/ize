...
export type ResolversTypes = {
  ...
  Action: ResolverTypeWrapper<
    Omit<Action, "actionDetails"> & {
      actionDetails?: Maybe<ResolversTypes["ActionType"]>;
    }
  >;
  ActionArgs: ActionArgs;
  ActionType: ResolverTypeWrapper<
    ResolversUnionTypes<ResolversTypes>["ActionType"]
  >;
  Agent: ResolverTypeWrapper<ResolversUnionTypes<ResolversTypes>["Agent"]>;
  AgentType: AgentType;
  Boolean: ResolverTypeWrapper<Scalars["Boolean"]["output"]>;
  DecisionArgs: DecisionArgs;
  DecisionTypes: ResolverTypeWrapper<
    ResolversUnionTypes<ResolversTypes>["DecisionTypes"]
  >;
  ...
  Process: ResolverTypeWrapper<
    Omit<Process, "decisionSystem"> & {
      decisionSystem: ResolversTypes["DecisionTypes"];
    }
  >;
  ...
  RoleArgs: RoleArgs;
  RoleType: RoleType;
  Roles: ResolverTypeWrapper<
    Omit<Roles, "edit" | "request" | "respond"> & {
      edit?: Maybe<ResolversTypes["Agent"]>;
      request: Array<ResolversTypes["Agent"]>;
      respond: Array<ResolversTypes["Agent"]>;
    }
  >;
...
export type ResolversParentTypes = {
  ...
  AbsoluteDecisionArgs: AbsoluteDecisionArgs;
  Action: Omit<Action, "actionDetails"> & {
    actionDetails?: Maybe<ResolversParentTypes["ActionType"]>;
  };
  ActionArgs: ActionArgs;
  ...
  PercentageDecisionArgs: PercentageDecisionArgs;
  Process: Omit<Process, "decisionSystem"> & {
    decisionSystem: ResolversParentTypes["DecisionTypes"];
  };
  ...
  Result: Result;
  RoleArgs: RoleArgs;
  Roles: Omit<Roles, "edit" | "request" | "respond"> & {
    edit?: Maybe<ResolversParentTypes["Agent"]>;
    request: Array<ResolversParentTypes["Agent"]>;
    respond: Array<ResolversParentTypes["Agent"]>;
  };
...
export type AbsoluteDecisionResolvers<
  ContextType = GraphqlRequestContext,
  ParentType extends
    ResolversParentTypes["AbsoluteDecision"] = ResolversParentTypes["AbsoluteDecision"],
> = {
...
> = {
  actionDetails?: Resolver<
    Maybe<ResolversTypes["ActionType"]>,
    ParentType,
    ContextType
  >;
  id?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  optionFilter?: Resolver<
    Maybe<ResolversTypes["ProcessOption"]>,
    ParentType,
    ContextType
  >;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type ActionTypeResolvers<
  ContextType = GraphqlRequestContext,
  ParentType extends
    ResolversParentTypes["ActionType"] = ResolversParentTypes["ActionType"],
> = {
  __resolveType: TypeResolveFn<
    "EvolveProcessAction" | "WebhookAction",
    ParentType,
    ContextType
  >;
};
...
export type DecisionTypesResolvers<
  ContextType = GraphqlRequestContext,
  ParentType extends
    ResolversParentTypes["DecisionTypes"] = ResolversParentTypes["DecisionTypes"],
> = {
  __resolveType: TypeResolveFn<
...
export type DiscordApiServerResolvers<
  ContextType = GraphqlRequestContext,
  ParentType extends
    ResolversParentTypes["DiscordAPIServer"] = ResolversParentTypes["DiscordAPIServer"],
> = {
  id?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
...
export type DiscordApiServerRoleResolvers<
  ContextType = GraphqlRequestContext,
  ParentType extends
    ResolversParentTypes["DiscordAPIServerRole"] = ResolversParentTypes["DiscordAPIServerRole"],
> = {
...
export type DiscordDataResolvers<
  ContextType = GraphqlRequestContext,
  ParentType extends
    ResolversParentTypes["DiscordData"] = ResolversParentTypes["DiscordData"],
> = {
...
export type DiscordRoleGroupResolvers<
  ContextType = GraphqlRequestContext,
  ParentType extends
    ResolversParentTypes["DiscordRoleGroup"] = ResolversParentTypes["DiscordRoleGroup"],
> = {
  color?: Resolver<Maybe<ResolversTypes["Int"]>, ParentType, ContextType>;
  discordRoleId?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  discordServer?: Resolver<
    ResolversTypes["OnboardedDiscordServer"],
    ParentType,
    ContextType
  >;
  icon?: Resolver<Maybe<ResolversTypes["String"]>, ParentType, ContextType>;
...
export type EvolveProcessActionResolvers<
  ContextType = GraphqlRequestContext,
  ParentType extends
    ResolversParentTypes["EvolveProcessAction"] = ResolversParentTypes["EvolveProcessAction"],
> = {
  _?: Resolver<Maybe<ResolversTypes["Boolean"]>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type EvolveProcessesDiffResolvers<
  ContextType = GraphqlRequestContext,
  ParentType extends
    ResolversParentTypes["EvolveProcessesDiff"] = ResolversParentTypes["EvolveProcessesDiff"],
> = {
  changes?: Resolver<
    ResolversTypes["ProposedProcessEvolution"],
    ParentType,
    ContextType
  >;
...
> = {
  ...
  discordRoleGroup?: Resolver<
    ResolversTypes["DiscordRoleGroup"],
    ParentType,
    ContextType
  >;
  icon?: Resolver<Maybe<ResolversTypes["String"]>, ParentType, ContextType>;
...
export type InputTemplateResolvers<
  ContextType = GraphqlRequestContext,
  ParentType extends
    ResolversParentTypes["InputTemplate"] = ResolversParentTypes["InputTemplate"],
> = {
...
> = {
  discordData?: Resolver<
    ResolversTypes["DiscordData"],
    ParentType,
    ContextType
  >;
  id?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
...
> = {
  logOut?: Resolver<
    ...
    ContextType
  >;
  newEditProcessRequest?: Resolver<
    ResolversTypes["String"],
    ParentType,
    ContextType,
    RequireFields<MutationNewEditProcessRequestArgs, "inputs">
  >;
  newProcess?: Resolver<
    ResolversTypes["String"],
    ParentType,
    ContextType,
    RequireFields<MutationNewProcessArgs, "process">
  >;
  newRequest?: Resolver<
    ResolversTypes["String"],
    ParentType,
    ContextType,
    RequireFields<MutationNewRequestArgs, "processId">
  >;
  newResponse?: Resolver<
    ResolversTypes["String"],
    ParentType,
    ContextType,
    RequireFields<MutationNewResponseArgs, "optionId" | "requestId">
  >;
  setUpDiscordServer?: Resolver<
    ResolversTypes["Group"],
    ParentType,
    ContextType,
    RequireFields<MutationSetUpDiscordServerArgs, "input">
  >;
};

export type OnboardedDiscordServerResolvers<
  ContextType = GraphqlRequestContext,
  ParentType extends
    ResolversParentTypes["OnboardedDiscordServer"] = ResolversParentTypes["OnboardedDiscordServer"],
> = {
...
export type ParentProcessResolvers<
  ContextType = GraphqlRequestContext,
  ParentType extends
    ResolversParentTypes["ParentProcess"] = ResolversParentTypes["ParentProcess"],
> = {
  id?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  name?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type PercentageDecisionResolvers<
  ContextType = GraphqlRequestContext,
  ParentType extends
    ResolversParentTypes["PercentageDecision"] = ResolversParentTypes["PercentageDecision"],
> = {
...
export type ProcessResolvers<
  ContextType = GraphqlRequestContext,
  ParentType extends
    ResolversParentTypes["Process"] = ResolversParentTypes["Process"],
> = {
  action?: Resolver<Maybe<ResolversTypes["Action"]>, ParentType, ContextType>;
  createdAt?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  creator?: Resolver<ResolversTypes["User"], ParentType, ContextType>;
  currentProcessVersionId?: Resolver<
    ResolversTypes["String"],
    ParentType,
    ContextType
  >;
  decisionSystem?: Resolver<
    ResolversTypes["DecisionTypes"],
    ParentType,
    ContextType
  >;
  description?: Resolver<
  ...
  id?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  inputs?: Resolver<
    Array<ResolversTypes["InputTemplate"]>,
    ParentType,
    ContextType
  >;
  name?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  options?: Resolver<
    Array<ResolversTypes["ProcessOption"]>,
    ParentType,
    ContextType
  >;
  parent?: Resolver<
    Maybe<ResolversTypes["ParentProcess"]>,
    ParentType,
    ContextType
  >;
...
export type ProcessOptionResolvers<
  ContextType = GraphqlRequestContext,
  ParentType extends
    ResolversParentTypes["ProcessOption"] = ResolversParentTypes["ProcessOption"],
> = {
  id?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
...
export type ProposedProcessEvolutionResolvers<
  ContextType = GraphqlRequestContext,
  ParentType extends
    ResolversParentTypes["ProposedProcessEvolution"] = ResolversParentTypes["ProposedProcessEvolution"],
> = {
...
> = {
  discordServerRoles?: Resolver<
    Array<ResolversTypes["DiscordAPIServerRole"]>,
    ParentType,
    ContextType,
    RequireFields<QueryDiscordServerRolesArgs, "serverId">
  >;
  discordServers?: Resolver<
    Array<ResolversTypes["DiscordAPIServer"]>,
    ParentType,
    ContextType
  >;
  group?: Resolver<
  ...
  >;
  groupsAndUsersEliglbeForRole?: Resolver<
    Array<ResolversTypes["Agent"]>,
    ParentType,
    ContextType
  >;
  groupsForCurrentUser?: Resolver<
  ...
  process?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryProcessArgs, "processId">
  >;
  processesForCurrentUser?: Resolver<
    Array<ResolversTypes["Process"]>,
    ParentType,
    ContextType,
    RequireFields<QueryProcessesForCurrentUserArgs, "requestRoleOnly">
  >;
  processesForGroup?: Resolver<
    Array<ResolversTypes["Process"]>,
    ParentType,
    ContextType,
    RequireFields<QueryProcessesForGroupArgs, "groupId">
  >;
  request?: Resolver<
    ResolversTypes["Request"],
    ParentType,
    ContextType,
    RequireFields<QueryRequestArgs, "requestId">
  >;
  requestsForCurrentUser?: Resolver<
    Array<ResolversTypes["Request"]>,
    ParentType,
    ContextType,
    RequireFields<QueryRequestsForCurrentUserArgs, "groups">
  >;
  requestsForGroup?: Resolver<
    Array<ResolversTypes["Request"]>,
    ParentType,
    ContextType,
    RequireFields<QueryRequestsForGroupArgs, "groupId">
  >;
  requestsForProcess?: Resolver<
    Array<ResolversTypes["Request"]>,
    ParentType,
    ContextType,
    RequireFields<QueryRequestsForProcessArgs, "processId">
  >;
  users?: Resolver<
...
> = {
  createdAt?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  creator?: Resolver<ResolversTypes["User"], ParentType, ContextType>;
  evolveProcessChanges?: Resolver<
    Maybe<Array<Maybe<ResolversTypes["EvolveProcessesDiff"]>>>,
    ParentType,
    ContextType
  >;
  ...
  id?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  inputs?: Resolver<
    Array<ResolversTypes["RequestInput"]>,
    ParentType,
    ContextType
  >;
  name?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
...
export type RequestInputResolvers<
  ContextType = GraphqlRequestContext,
  ParentType extends
    ResolversParentTypes["RequestInput"] = ResolversParentTypes["RequestInput"],
> = {
  description?: Resolver<
    Maybe<ResolversTypes["String"]>,
    ParentType,
...
export type ResponseCountResolvers<
  ContextType = GraphqlRequestContext,
  ParentType extends
    ResolversParentTypes["ResponseCount"] = ResolversParentTypes["ResponseCount"],
> = {
...
export type ResponsesResolvers<
  ContextType = GraphqlRequestContext,
  ParentType extends
    ResolversParentTypes["Responses"] = ResolversParentTypes["Responses"],
> = {
  allResponses?: Resolver<
    Array<ResolversTypes["Response"]>,
    ParentType,
    ContextType
  >;
  responseCount?: Resolver<
    Array<ResolversTypes["ResponseCount"]>,
    ParentType,
    ContextType
  >;
...
export type ResultResolvers<
  ContextType = GraphqlRequestContext,
  ParentType extends
    ResolversParentTypes["Result"] = ResolversParentTypes["Result"],
> = {
  actionComplete?: Resolver<ResolversTypes["Boolean"], ParentType, ContextType>;
  createdAt?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  id?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  selectedOption?: Resolver<
    ResolversTypes["ProcessOption"],
    ParentType,
    ContextType
  >;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type RolesResolvers<
  ContextType = GraphqlRequestContext,
  ParentType extends
    ResolversParentTypes["Roles"] = ResolversParentTypes["Roles"],
> = {
...
export type WebhookActionResolvers<
  ContextType = GraphqlRequestContext,
  ParentType extends
    ResolversParentTypes["WebhookAction"] = ResolversParentTypes["WebhookAction"],
> = {
