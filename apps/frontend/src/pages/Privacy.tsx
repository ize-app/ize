...
export const Privacy = () => {
  return (
    <>
      <Head title={"Privacy Policy"} description={"Ize Privacy Policy"} />
      <div style={{ margin: "0px 30px 30px 30px" }}>
        <>
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Application</strong> refers to Ize, the software program provided by the
                Company.
              </p>
            </li>
            <li>
              <p>
                ...
                in this Agreement) refers to Ize.
              </p>
            </li>
            <li>
              <p>
          ...
          <ul>
            <li>By email: ize.inquiries@gmail.com</li>
          </ul>
        </>
      </div>
    </>
