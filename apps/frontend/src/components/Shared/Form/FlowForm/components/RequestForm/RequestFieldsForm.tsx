...
interface RequestFieldsFormProps {
  ...
  requestInputFormMethods: UseFieldArrayReturn<FlowSchemaType>;
...
export const RequestFieldsForm = ({
  ...
  return (
    <LabeledGroupedInputs label="Request fields">
      <Box sx={{ backgroundColor: "#FBF5FD" }}>
        <TableContainer
          sx={{
            overflowX: "auto",
            maxWidth: "1000px",
                  ...
                  <TableRow key={item.id}>
                    ...
                    <TableCell sx={{ minWidth: "150px" }}>
                      ...
                      <TextField<FlowSchemaType>
                        ...
                        control={control}
                        placeholderText={`Field name - how do you want requestors to fill out this field?`}
                        label={``}
                      />
                    </TableCell>
                    <TableCell
